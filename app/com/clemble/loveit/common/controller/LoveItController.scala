...
abstract class LoveItController(silhouette: Silhouette[AuthEnv], controllerComponents: ControllerComponents) extends AbstractController(controllerComponents) {
