...
import com.clemble.loveit.common.model.{User, UserAware}
...
case class UserPayment(
                        ...
                        charges: List[PendingTransaction] = List.empty[PendingTransaction],
                        payouts: List[PendingTransaction] = List.empty[PendingTransaction]
                      ) extends UserAware {
