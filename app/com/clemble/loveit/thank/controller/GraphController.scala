...
import com.clemble.loveit.common.model.{OpenGraphObject, Post, ProjectID, Resource, Tag, UserID}
...
class GraphController @Inject()(
  ...
  def searchByTags() = silhouette.UnsecuredAction.async(implicit req => {
